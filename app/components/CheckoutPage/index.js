...
function CheckoutPage({
  ...
  useEffect(() => {
    if (publishDetails.planData) setPlanItem(publishDetails.planData);
    if (publishDetails.planData) {
      setTotalAmount(publishDetails.planData.planPrice);
    }
  }, []);
    ...
    apiClient
      ...
      .then(response => {
        ...
        if (response.status === 200) {
          ...
          setCouponOff(response.data.data.offAmount);
          setSubmitError({
          ...
          <div className="flex mb-auto">
            <div className="container mx-auto px-8">
              <div className="flex px-10">
                <div className="w-full pl-6 text-2xl">Review and Upgrade</div>
              </div>
              <div className="px-10 pb-3">
                <div className="px-4 mt-2">
                  <div className="flex w-full p-8 px-14 text-gray-800 bg-white shadow-lg pin-r pin-y">
                    <div className="flex-1">
                      <div className="my-4 -mx-2 lg:flex">
                        <div className="lg:px-2 lg:w-2/3">
                          <div className="p-2 mx-2 bg-gray-100 ">
                          ...
                          <div className="p-4 mb-3">
                            <p className="mb-6 text-sm italic">
                              Cost are calcutated based on feature you have
                              slected.
                            </p>
                            <div className="flex justify-between pt-2 border-b">
                              <div className="lg:px-4 lg:py-2 m-2 text-sm lg:text-md text-center text-gray-800">
                                <span>
                                  Plan - <span>{planItem.planName}</span> ({' '}
                                  <span>{planItem.planDuration}</span> )
                                </span>
                              </div>
                              <div className="lg:px-4 lg:py-2 m-2 lg:text-md text-center text-gray-900">
                                <span>
                                  {planItem.planPrice} <span>INR</span>
                                </span>
                              </div>
                            </div>
                            <div className="flex justify-between pt-2 border-b">
                        ...
                        <div className="lg:px-2 lg:w-1/3">
                          ...
                          <div className="p-2 mx-2 mt-6 bg-gray-100 ">
                          ...
                          <div className="p-4 mb-3">
                            <div className="flexborder-t border-b">
                              <p className="mb-4 pl-2 text-sm">
                                <span>
                                  Refer & Register any two member and get INR 50
                                  Off Coupon.{' '}
                                  <span
