              ...
              {accountVerifyStatus === true ? (
                <div className="flex-auto px-4 lg:px-10 py-6 pt-0">
                  ...
                  <div className="text-center mt-6">
                    ...
                    <Link
                      to="/login"
                      className="bw-full bg-gray-900 text-white active:bg-gray-700 text-sm font-bold uppercase px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 w-full"
                    >
                      Login
                    </Link>
                  </div>
