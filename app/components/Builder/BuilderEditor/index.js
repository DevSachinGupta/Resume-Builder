...
const TemplateHTML = require(`../../CheerioComponent/templates/template_${templateNumber}/html.js`);
...
function BuilderEditor({
  ...
  // var data = InjectFullJSONUsingCheerio(DemoPage.html , resume_json_state)
