...
var JSONData = JSON.parse(fs1.readFileSync("sample_json_output.json"));
var data = fs1.readFileSync("index.html");
...
var final_data = $.html()
fs1.writeFile("generated_html.html", final_data , function(err) {
    if(err) {
