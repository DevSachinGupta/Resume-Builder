...
@font-face { font-family: 'icomoon';src:  url('../fonts/icomoon.eot?ys0ipk');src:  url('../fonts/icomoon.eot?ys0ipk#iefix') format('embedded-opentype'), url('../fonts/icomoon.ttf?ys0ipk') format('truetype'),url('../fonts/icomoon.woff?ys0ipk') format('woff'), url('../fonts/icomoon.svg?ys0ipk#icomoon') format('svg'); font-weight: normal; font-style: normal; font-display: block; }  
